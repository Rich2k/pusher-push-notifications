# Pusher push notifications channel for Laravel 5.3 - 5.5
...
This package makes it easy to send [Pusher push notifications](https://pusher.com/docs/push_notifications) with Laravel 5.3 - 5.5.
